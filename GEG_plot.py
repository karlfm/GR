...
def plot_results(file_name):
    ...
    plotter_instance = plotter.ComparisonPlotter(R_range, number_of_lines, model_name="GEG")
    ...
    plotter_instance.plot_spatial_panel((1, 1), "Hoop Strain", "Strain", plot_data["hoop_strain"], set_point=stretch_set_point)
